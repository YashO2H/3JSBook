...
export const getPages = (pictures = [], isExtraRequired = false) => {
  const pages = [];
  ...
  if (pictures.length >= 2) {
    ...
    pages.push({ front: pictures[0], back: pictures[1] });

    for (let i = 2; i < pictures.length - 2; i += 2) {
      pages.push({
        front: pictures[i],
        back: pictures[i + 1],
      });
